CLASS zcm_00_connection DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF unsupported_distance_unit,
        msgid TYPE symsgid VALUE 'Z00',
        msgno TYPE symsgno VALUE '000',
        attr1 TYPE scx_attrname VALUE 'DISTANCE_UNIT',
        attr2 TYPE scx_attrname VALUE 'attr2',
        attr3 TYPE scx_attrname VALUE 'attr3',
        attr4 TYPE scx_attrname VALUE 'attr4',
      END OF unsupported_distance_unit.

    CONSTANTS:
      BEGIN OF conversion_successful,
        msgid TYPE symsgid VALUE 'Z00',
        ...
        attr3 TYPE scx_attrname VALUE 'attr3',
        attr4 TYPE scx_attrname VALUE 'attr4',
      END OF conversion_successful.

    DATA distance_unit TYPE s_distid.
    ...
    METHODS constructor
      IMPORTING
        ...
        i_distance_unit          TYPE s_distid OPTIONAL.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
